...
#if 0
/home/sfulham/dev/InternalEngine/Internal/libs/vulkan/Linux/samples/API-Samples/multithreaded_command_buffers/multithreaded_command_buffers.vert
...
// Id's are bound by 24
               ...
               1:             ExtInstImport  "GLSL.std.450"
                              ...
                              EntryPoint Vertex 4  "main" 9 11 18 21
                              Source GLSL 400
...
16(gl_PerVertex):             TypeStruct 7(fvec4) 6(float) 15
         ...
         21(pos):     10(ptr) Variable Input
         4(main):           2 Function None 3
               5:             Label
              12:    7(fvec4) Load 11(inColor)
                              Store 9(outColor) 12
              22:    7(fvec4) Load 21(pos)
              23:      8(ptr) AccessChain 18 20
                              Store 23 22
                              Return
                              FunctionEnd
#endif

static const uint32_t multithreaded_command_buffers_vert[214] = {
    0x07230203, 0x00010000, 0x00080008, 0x00000018,
    0x00000000, 0x00020011, 0x00000001, 0x0006000b,
    0x00000001, 0x4c534c47, 0x6474732e, 0x3035342e,
    0x00000000, 0x0003000e, 0x00000000, 0x00000001,
    0x0009000f, 0x00000000, 0x00000004, 0x6e69616d,
    0x00000000, 0x00000009, 0x0000000b, 0x00000012,
    0x00000015, 0x00030003, 0x00000002, 0x00000190,
    ...
    0x00030005, 0x00000015, 0x00736f70, 0x00040047,
    ...
    0x0000000b, 0x00000003, 0x00030047, 0x00000010,
    0x00000002, 0x00040047, 0x00000015, 0x0000001e,
